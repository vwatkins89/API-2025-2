...
public class OpenApiConfig {
	...
	OpenAPI myOpenApi() {
		...
		contact.setEmail("roni@gmail.com");
		contact.setName("Roni");
		contact.setUrl("www.meudominio.com.br");
		
		Info info = new Info().title("API DE TESTE").version("1.0")
				.contact(contact).termsOfService("Api usada para testes");
